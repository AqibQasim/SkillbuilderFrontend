...
const takeintro = () => {
  return (
    <>
        <div className='w-full flex flex-col h-[100vh] p-6 bg-bg_gray'>
            ...
            <div className='w-full gap-4 flex flex-wrap self-end justify-center p-4 items-center md:items-end lg:items-end h-[9em] 
