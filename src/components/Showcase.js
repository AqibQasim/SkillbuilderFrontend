  ...
  return (
    ...
    <LayoutXPadding>
      <div className="mx-3 !mt-0 rounded-[1.25rem] bg-[#F3F7FA] !px-4 !pt-4 sm:!px-[3.1rem] md:pt-11 xl:mx-5">
        ...
        >
          {/* Shape */}
          <div className="border-shape absolute -top-48 left-0 hidden size-12 bg-[#2A6ED4] mix-blend-overlay md:-top-52 md:block lg:-top-60 xl:size-16 2xl:-top-64"></div>
          {/* Shape2 */}
          ...
          {/* Shape 3 */}
          <div className="shape-2 absolute -top-[12rem] right-0 hidden size-64 items-start justify-end bg-[#F3F7FA] md:flex">
          ...
          >
            ...
            <video
              className="h-full w-full rounded-t-[2rem] object-contain object-center md:object-cover"
