...
export const globeInstructorCardMarkup = `<div className="test-card bg-[rgba(255, 255, 255, 0.5)] w-max max-w-[400px] space-y-4 rounded-[1.25rem] p-4 shadow-[inset_0_0_0_2px_#F6EBEB] backdrop-blur-[7px]">
