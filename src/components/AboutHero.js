      ...
      >
        ...
        <div className="flex-1  text-black">
          ...
          <div className="mx-auto max-w-[43rem] xl:mx-0 xl:max-w-none xl:pr-24">
            {/* Content */}
            <h1 className="mx-auto mb-4 text-5xl text-center xl:text-left font-semibold xl:mx-0">
              Your success is our
              <br /> <span className="text-blue-600">Motivation</span>
            </h1>
            <p
              className={`text-md mb-8 font-normal leading-7 text-gray-600 text-center xl:text-left`}
            >
