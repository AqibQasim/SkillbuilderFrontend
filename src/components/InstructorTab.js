...
const InstructorTab = (props) => {
  return (
    <div className="hidden items-center gap-0 space-x-1 w-[40%] py-5 justify-center rounded-full p-1 min-w-max self-start 
        ...
        <div className="flex items-center justify-center bg-blue gap-12 text-white rounded-full min-w-max px-4 py-2 cursor-pointer">
        ...
        <div className="flex items-center justify-center text-blue gap-12 border-2 border-blue bg-white rounded-full px-6 py-2 cursor-pointer">
