...
const Profile = ({ profile_text }) => {
  ...
  //     <div className="hero bg-white py-16">
  //       <LayoutWidth>
  ...
  //             )}
  //           </div>
  //           <div className="mb-auto mt-auto flex flex-col gap-5 lg:items-start max-sm:items-center max-md:items-center">
  //             {/* <h1 className="mb-3 text-3xl font-bold leading-5 md:text-xl lg:text-xl max-xsm:text-sm"> */}
  //             <h1 className="text-5xl font-bold">
  //               {first_name ? `${first_name} ` : "Set name "}
  //               {last_name ? `${last_name}` : "Please"}{" "}
  //             </h1>
  //             {/* <p className="text-wrap font-normal lg:text-sm max-sm:text-xs max-md:text-xs"> */}
  //             <p className="text-wrap text-xl font-normal">
  //               Email:
  ...
  //             </p>
  //             {/* <p className="text-wrap font-normal lg:text-sm max-sm:text-xs max-md:text-xs"> */}
  //             <p className="flex items-center justify-center gap-2 text-wrap text-xl font-normal">
  //               Location:
  //               <span className="pl-1 font-light text-bg_text_gray">
  ...
  //           </div>
  //           {/* icons */}
  //           <div className="ml-auto flex flex-col gap-20 lg:items-end lg:gap-20 max-xsm:items-center max-xsm:gap-5 max-md:items-center max-md:gap-5">
  //             <div>
  //               <Image
  //                 src="/Icon.svg"
  //                 alt=""
  ...
  //               />
  //             </div>
  //             <div className="mt-auto flex gap-3 sm:flex-row md:flex-row lg:flex-row">
