...
>>>>>>> 5b09ea164d6a230fae14cc63788081412f908660
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <div className="h-auto w-[90%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 place-items-center">
          {courses.map((course) => (
            <div
              key={course.id}
              className="img-container border border-cards_gray h-auto w-full max-w-sm mb-4 bg-white rounded-2xl p-2 flex flex-col items-start"
            >
              <Image
...
=======
    ...
    return (
        <>
            <div className={`${paddingTop} w-[90%] flex justify-between mt-[-0.5rem]   h-auto my-8 max-sm:my-0 max-sm:mb-6 max-sm:mt-[-3rem] `}>
                <h2 className="text-2xl font-semibold max-sm:text-xl max-sm:mt-4 ">{heading}</h2>
            ...
            <div className="w-full flex flex-col justify-center items-center">
                <div className="h-auto w-[90%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 place-items-center">
                    {courses.map(course => (
                        <div key={course.id} className="img-container border border-cards_gray h-auto w-full max-w-sm mb-4 bg-white rounded-2xl p-2 flex flex-col items-start transform transition transition-shadow duration-300 hover:shadow-lg hover:border-[rgb(152,159,233)]">
