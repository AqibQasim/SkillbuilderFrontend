...
const Reviewdropdown = ({ text }) => {
  return (
    <div>
      <button
        id="dropdownDefaultButton"
        data-dropdown-toggle="dropdown"
        className=" text-blue text-xl font-medium outline  focus:outline-none  font-medium text-sm   text-center inline-flex items-center px-5 py-2.5 max-sm:w-full justify-center"
        type="button"
      >
        {text}
