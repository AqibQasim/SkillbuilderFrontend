  ...
  return (
    <div className="relative inline-block text-black">
      <button
        ...
        className="text-status-text flex w-full items-center justify-between gap-4 border border-dashboard-border px-5 py-2 font-medium capitalize shadow-sm transition-colors duration-300"
      >
