...
export function LiveCoursesCard({ className }) {
    return (
      <div
        className={`${className} is-odd group explore-courses-card group relative grid max-w-[25.25rem] grid-rows-[13.375rem_1fr] overflow-hidden rounded-[0.875rem]`}
      >
  ...
  export default LiveCoursesCard;